              ...
              <div className="p-6 bg-gray-50">
                ...
                {currentType === "Special" && (
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 animate-in slide-in-from-bottom-2 mb-6">
                      {["Bitmoji", "Stranger Things", "Simpsons", "Disney"].map(
                        (style) => {
                          const isSelected =
                            (currentDesign?.title || currentDesign) === style;
                          return (
                            <div
                              key={style}
                              onClick={() => setDesign(style)}
                              className={`p-3 border-2 rounded-xl text-center text-xs font-bold cursor-pointer transition-all active:scale-95 h-20 flex items-center justify-center
                              ${
                                isSelected
                                  ? "border-purple-600 bg-purple-50 text-purple-700 ring-2 ring-purple-100"
                                  : "bg-white border-gray-200 hover:border-purple-300 hover:text-purple-700"
                              }
                            `}
                            >
                              {style}
